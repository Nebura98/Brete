...
public sealed class CompanyEventSourcingHandler : IEventSourcingHandler<CompanyAggregate>
{
    private readonly IEventStore _eventStore;
    private readonly IEventProducer _eventProducer;

    public CompanyEventSourcingHandler(IEventStore eventStore, IEventProducer eventProducer)
    {
